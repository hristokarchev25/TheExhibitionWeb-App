                        ...
                        <div class="col">
                            <div class="card border-danger">
                                ...
                                <div class="card-body text-center py-4">
                                    ...
                                    <div class="mt-3">
                                        <Link to={`/suzannePage/suzanneCollection/${post.key}`} class="btn btn-primary">Read More</Link>
                                    </div>
                                </div>
                            </div>
                        </div>)
...
export default SuzanneExhibition